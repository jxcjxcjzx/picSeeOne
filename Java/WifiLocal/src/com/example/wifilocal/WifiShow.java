...
public class WifiShow extends Activity {
	...
	protected void storeThemAll() {
		...
		db.close();
		Toast.makeText(this, "finished saving", Toast.LENGTH_LONG).show();
	}
	...
	public void buttonRefresh(){
		loc_control.setText("x  зјБъ   : "+String.valueOf(loc_num));
		time_control.setText("y   зјБъ   : "+String.valueOf(time_num));
	}
