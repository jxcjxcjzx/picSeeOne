...
parser.setURL(url); parser.setEncoding("GBK"); 
 ...
 */
 ...
 NodeList list = ((CompositeTag) tag).getChildren(); if (list != null) { NodeIterator it = list.elements(); while (it.hasMoreNodes()) { Node node = it.nextNode();
 ...
 */
 ...
 search_key_words = sf.accept((Node) sNode);
 ...
 */
  ...
  */
  ...
  while ((line = reader.readLine()) != null) { if (line.indexOf("Disallow:") == 0) {//是否包含"Disallow:" 
  ...
  String file = urlToCheck.getFile(); // System.out.println("文件getFile()="+file); 
  ...
  public static void main(String[] args) {
	    ...
	    Spider ph = new Spider("经济", "http://www.baidu.com");
